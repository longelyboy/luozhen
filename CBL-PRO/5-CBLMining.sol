...
// File: contracts/CBLMiningContract.sol

pragma solidity 0.6.6;


contract CBLMining is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    IERC20 public cblToken; //  cbl TOKE
    ...
    function takeFee(uint256 _totalReward) private {
        ...
        ICBL iCBLToken = ICBL(address(cblToken));
        ...
        (invitor1,invitor2)=iCBLToken.getInvitors(_msgSender(),isCompress);
    ...
    function safeMiningTokenTransfer(address _to, uint256 _amount) internal {
        ...
        require(bal >= _amount, "CBLMiningContract' balance is not enough.");
        cblToken.safeTransfer(_to, _amount);
    }
}